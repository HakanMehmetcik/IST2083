...
R'da farklı dağılım türleri için çeşitli fonksiyonlar bulunmaktadır. Bu fonksiyonlar genellikle dört ana işlevi yerine getirir:
...
Dağılım fonksiyonu, belirli bir x değerine kadar olan kümülatif olasılığı hesaplar. Bu, rastgele değişkenin $X≤x$ olma olasılığını ifade eder.
Örneğin, bir zar atıldığında $x≤3$ gelme olasılığını hesaplamak için:
...
Aşağıda her bir fonksiyon türüyle ilgili detaylı açıklamaları ve örnekleri bulabilirsiniz:

------------------------------------------------------------------------

### **1. Yoğunluk Fonksiyonu (Density Function)**

Yoğunluk fonksiyonu, bir rastgele değişkenin belirli bir xxx değerine sahip olma olasılık yoğunluğunu hesaplar. Kesikli dağılımlar için bu, xxx'in olasılığını verir. Sürekli dağılımlarda ise yoğunluk değerleri, olasılık olarak değil, birim aralığındaki yoğunluk olarak yorumlanır.

-   **Kesikli Dağılımlar:**
    Örneğin, bir zar atıldığında x=3x = 3x=3 gelme olasılığını hesaplamak için binom yoğunluk fonksiyonu kullanılır.
...
-   **Sürekli Dağılımlar:**
    Sürekli dağılımlarda yoğunluk bir olasılık değildir, ancak bir aralıktaki olasılık hesaplamalarına katkı sağlar.
    ...
    `dnorm(0, mean = 0, sd = 1)  # Normal dağılımda x = 0 yoğunluğu`

------------------------------------------------------------------------

### **2. Dağılım Fonksiyonu (Distribution Function)**

Dağılım fonksiyonu, belirli bir xxx değerine kadar olan kümülatif olasılığı hesaplar. Bu, rastgele değişkenin X≤xX \leq xX≤x olma olasılığını ifade eder.

-   **Kesikli Dağılımlar:**
    Örneğin, bir zar atıldığında x≤3x \leq 3x≤3 gelme olasılığını hesaplamak için:
...
-   **Sürekli Dağılımlar:**
    Sürekli dağılımlarda belirli bir değere kadar olan alanın (integral) hesaplanmasıdır.
    ...
    `pnorm(1, mean = 0, sd = 1)  # x ≤ 1 için kümülatif olasılık`

------------------------------------------------------------------------

### **3. Ters Dağılım Fonksiyonu (Quantile Function)**

Ters dağılım fonksiyonu, belirli bir olasılık değerine karşılık gelen xxx değerini verir. Bu, belirli bir yüzdelik dilimdeki değeri bulmak için kullanılır.
...
-   **Sürekli Dağılımlar:**
    Sürekli bir dağılımda belirli bir yüzdelik dilim (ppp) için karşılık gelen xxx değeri:
...
### **4. Rastgele Sayı Üretme (Random Generation)**
...
-   **Kesikli Dağılımlar:**
    Binom dağılımından rastgele 10 değer üretmek:
...
-   **Sürekli Dağılımlar:**
    Normal dağılımdan rastgele 10 değer üretmek:
