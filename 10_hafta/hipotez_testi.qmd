...
-   **Eğer p-değeri** α'dan küçükse:
    ...
    -   **H₀ reddedilir ve H₁ kabul edilir.**\
        Bu durumda, p-değeri, gözlemlenen sonuçların null hipotez (H₀​) doğruyken oluşma olasılığının çok düşük olduğunu gösterir. Bu nedenle, H0H₀H0​ reddedilir ve alternatif hipotez (H₁​) desteklenir.
