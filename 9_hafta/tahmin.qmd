...
# Sonucu yazdır
print(paste("Bir öğrencinin IQ puanının 89'dan büyük olma olasılığı:", round(1-prob, 4)))
...
Ancak, popülasyonun gerçek parametrelerini bilmiyorsanız ve örneklem verileriyle çalışıyorsanız, genellikle z-skoru değerlerini hesaplamalarınızda kullanırsınız.
...
Peki ya daha büyük değerlere bakmayı düşünsek!
